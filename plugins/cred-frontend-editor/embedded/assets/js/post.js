(function (window, $, settings, utils, gui, undefined) {
    ...
    var aux = {
        checkButton: function ()
        {
            ...
            switch (mode.attr('id'))
            {
                ...
                case 'cred-user-edit-container':
                    $('#cred-user-edit-container-advanced input[name="cred-edit-how-to-display"]').prop("checked", "checked");
                    if ($('#cred-user-edit-container-advanced input[name="cred-edit-how-to-display"]:checked').val() == 'insert-link')
                    {
                    ...
                    if ($('#cred-user-edit-container-advanced input[name="cred-edit-what-to-edit"]:checked').val() == 'edit-other-user')
                    {
                    ...
                    else
                    {
                        ...
                        if (
                                $('#cred-user-edit-container-advanced input[name="cred-edit-what-to-edit"]:checked').val() == 'edit-other-user'
                                &&
                                (!_vv || '' == _vv)
                                )
                        {
        ...
        checkButton2: function ($parent)
        {
            ...
            {
                _vv = $('.cred-user-edit-container-advanced2 input[name^="cred-edit-how-to-display"]:checked', $parent).val();
                if ('insert-link' == _vv)
                {
                    $('.cred-edit-link-text-container2', $parent).show();
                }
                ...
                _vv = $('.cred-user-edit-container-advanced2 input[name^="cred-edit-what-to-edit"]:checked', $parent).val();
                if ('edit-other-post' == _vv)
                {
                    $('.cred-edit-other-post-more2', $parent).show();
                }
                ...
                else
                {
                    ...
                    if (
                            'edit-other-user' == $('.cred-user-edit-container-advanced2 input[name^="cred-edit-what-to-edit"]:checked', $parent).val()
                            &&
                            ('' == _vv || !_vv)
                            )
                    {
        ...
        popupHandler: function (event)
        {
            ...
            switch (mode.attr('id'))
            {
                ...
                case 'cred-user-edit-container':
                    ...
                    //post_id=null;
                    switch ($('#cred-user-edit-container-advanced input[name="cred-edit-what-to-edit"]:checked').val())
                    {
                    ...
                    switch ($('#cred-user-edit-container-advanced input[name="cred-edit-how-to-display"]:checked').val())
                    {
                        case 'insert-link':
        ...
        popupHandler2: function (event)
        {
            ...
            else if (mode.hasClass('cred-user-edit-container2'))
            {
                ...
                else
                {
                    ...
                    //post_id=null;
                    switch ($('.cred-user-edit-container-advanced2 input[name^="cred-edit-what-to-edit"]:checked', $parent).val())
                    {
                        case 'edit-current-user':
                            post_id = null;
                            break;
                    ...
                    if (!error)
                    {
                        switch ($('.cred-user-edit-container-advanced2 input[name^="cred-edit-how-to-display"]:checked', $parent).val())
                        {
                            case 'insert-link':
                                var _class = '', _target = '_self', _style = '', _text = '', _more_atts = '', _atts = [];
                                _class = $('.cred-edit-html-class2', $parent).val();
    ...
    var self = {
        ...
        posts: function () {
            ...
            $('.cred-form-shortcodes-box2').on('change', '.cred-shortcode-container-radio', function (event) {
                event.stopPropagation();
