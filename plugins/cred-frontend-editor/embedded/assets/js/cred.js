...
//                    }
        ...
        reloadUserFields: function () {
            ...
            credView.reloadUserFields(ag_username_is_checked, ag_password_is_checked);
        },
    ...
    var self = {
        ...
        forms: function (useCodeMirror)
        {
            ...
            credView = new mvc.View('cred', _credModel, {
                reloadUserFields: function (ag_username_is_checked, ag_password_is_checked) {
                    loader.show();
                    ...
                    $.ajax({
                        ...
                        timeout: 10000,
                        type: 'POST',
                        data: 'ag_pass=' + ag_password_is_checked + '&ag_uname=' + ag_username_is_checked + '&_wpnonce=' + settings._cred_wpnonce,
                        dataType: 'json',
                                ...
                                if ('[post][post_type]' == data.key)
                                {
                                    ...
                                    if (cred_settings._current_page == 'cred-user-form') {
                                        $.ajax({
                                            ...
                                            timeout: 10000,
                                            type: 'POST',
                                            data: '_wpnonce=' + settings._cred_wpnonce,
                                            dataType: 'json',
                                            success: function (resp) {
                                                // load and dispatch event of fields loaded
                                                aux.onLoad(resp);
