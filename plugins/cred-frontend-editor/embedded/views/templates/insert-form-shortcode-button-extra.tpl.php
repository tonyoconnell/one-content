                ...
                <table class='cred-table' cellpadding=0 cellspacing=0>
                    <tr>
                        <td><?php _e('Select user form', 'wp-cred'); ?>
                            <select style='position:relative;' class="cred_form-edit-shortcode-select2" name="cred_user_form-edit-shortcode-select-<?php echo $id; ?>">
                                <optgroup label="<?php echo esc_attr(__('Select user form', 'wp-cred')); ?>">
                                    <option value='' disabled selected style='display:none;'><?php _e('Select user form', 'wp-cred'); ?></option>
                ...
                <div class='cred-shortcodes-container-advanced cred-user-edit-container-advanced2'>
                    <fieldset class='cred-fieldset'>
                        ...
                        <table class='cred-table' cellpadding=0 cellspacing=0>
                            <tr>
                                <td colspan=2>
                                    <label class='cred-label'><input type='radio' checked='checked' class='cred-advanced-options-radio cred-radio-10' name='cred-edit-what-to-edit-<?php echo $id; ?>' value='edit-current-user' /><span class='cred-radio-replace'></span>
                                        <span ><?php _e('Edit current user (in Loop)', 'wp-cred'); ?></span></label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan=2>
                                    <label class='cred-label'><input type='radio' class='cred-advanced-options-radio cred-radio-10' name='cred-edit-what-to-edit-<?php echo $id; ?>' value='edit-other-user' /><span class='cred-radio-replace'></span>
