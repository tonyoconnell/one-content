                ...
                <div id='cred-user-edit-container-advanced' class='cred-shortcodes-container-advanced'>
                    <fieldset class='cred-fieldset'>
                        ...
                        <table class='cred-table' cellpadding=0 cellspacing=0>
                            <tr>
                                <td colspan=2>
                                    <label class='cred-label'><input type='radio' checked='checked' class='cred-advanced-options-radio cred-radio-10' name='cred-edit-what-to-edit' value='edit-current-user' />
                            ...
                            <tr>
                                <td colspan=2>
                                    <label class='cred-label'><input type='radio' class='cred-advanced-options-radio cred-radio-10' name='cred-edit-what-to-edit' value='edit-other-user' />
                    ...
                    <fieldset class='cred-fieldset'>
                        ...
                        <table class='cred-table' cellpadding=0 cellspacing=0>
                            ...
                            <tr>
                                <td colspan=2>
                                    <label class='cred-label'><input type='radio' class='cred-advanced-options-radio cred-radio-10' name='cred-edit-how-to-display' value='insert-form' checked="checked" />
