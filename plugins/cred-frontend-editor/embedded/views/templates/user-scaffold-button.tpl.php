...
<span id="cred-scaffold-button" class="cred-media-button">
    ...
    <div id="cred-scaffold-box" class="cred-popup-box">
        <div class='cred-popup-heading'>
            <h3><?php _e('Scaffold User Form Content', 'wp-cred'); ?></h3>
        ...
        <div id="cred-scaffold-box-inner" class="cred-popup-inner">
            ...
            <p>
                <?php _e("This scaffold includes inputs for all the fields that belong to the form's user type.", 'wp-cred'); ?>
            ...
            <ul>
                <li>
                    <label class='cred-label'>
                        <input type='checkbox' class='cred_autogenerate_scaffold' name='_cred[form][autogenerate_username_scaffold]' id='cred_autogenerate_username_scaffold' value='1' <?php if (isset($autogenerate_username_scaffold) && $autogenerate_username_scaffold) echo 'checked="checked"'; ?> /><span class='cred-checkbox-replace'></span>
                        <span><?php _e('Autogenerate Username', 'wp-cred'); ?></span>
                    </label>
                </li>
                <li>
                    <label class='cred-label'>
                        <input type='checkbox' class='cred_autogenerate_scaffold' name='_cred[form][autogenerate_password_scaffold]' id='cred_autogenerate_password_scaffold' value='1' <?php if (isset($autogenerate_password_scaffold) && $autogenerate_password_scaffold) echo 'checked="checked"'; ?> /><span class='cred-checkbox-replace'></span>
