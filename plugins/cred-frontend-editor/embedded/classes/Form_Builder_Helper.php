...
//    }
    ...
    public function CRED_extractUserFields($user_id, $user_role, $track = false) {
        ...
        $autogenerate_user = $_fields['form_settings']->form['autogenerate_username_scaffold'] == 1 ? true : false;
        $autogenerate_pass = $_fields['form_settings']->form['autogenerate_password_scaffold'] == 1 ? true : false;
...
//            $post->post_author = $user_ID;
        ...
        if ($autogenerate_user) {
            $username_generated = StaticClass::generateRandomString(8);
            $user["user_login"] = $username_generated;
            $message[] .= "Your username is: $username_generated";
        }

        if (isset($user['user_email']) &&
                ($autogenerate_pass || $autogenerate_user)) {
            ...
            $mailer->setBody(implode("<br>", $message));
...
//                        }
    ...
    public function CRED_extractCustomUserFields($user_id, $track = false) {
        ...
        foreach ($_fields['custom_fields'] as $key => $field) {
            ...
            if (isset($field['meta_key']) && isset($_POST[$field['meta_key']])) {                
                if (!empty($_POST[$field['meta_key']]))
