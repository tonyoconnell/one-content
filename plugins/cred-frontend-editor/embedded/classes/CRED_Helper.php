    ...
    public static function jsForCredCustomPost() {
        ...
        if ((self::$currentPage->isCustomPostEdit || self::$currentPage->isCustomPostNew) ||
            ...
            if ((isset($_GET['post_type']) && (
                    CRED_FORMS_CUSTOM_POST_NAME == $_GET['post_type'] || CRED_USER_FORMS_CUSTOM_POST_NAME == $_GET['post_type'])))
                $newform = true;

            $sm = CRED_Loader::get('MODEL/Settings');
            $settings = $sm->getSettings();
            $fm = (CRED_USER_FORMS_CUSTOM_POST_NAME == $_GET['post_type']) ? CRED_Loader::get('MODEL/UserForms') : CRED_Loader::get('MODEL/Forms');
