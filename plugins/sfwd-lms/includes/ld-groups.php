	...
	<div id="learndash_groups_page_box" class="learndash_groups_page_box">
			...
			if ( ! empty( $all_group_leaders ) ) : ?>
				<table>
					<tr>
						...
						<td align="center">
							<a href="#" onClick="SelectAddRows(document.getElementById('learndash_group_leaders_search'), document.getElementById('learndash_group_leaders')); SelectAll(document.getElementById('learndash_group_leaders')); return false;"><img src="<?php echo plugins_url( "/assets/images/arrow_right.png", __DIR__); ?>" /></a><br>
							<a href="#" onClick="SelectRemoveRows(document.getElementById('learndash_group_leaders')); SelectAll(document.getElementById('learndash_group_leaders')); return false;"><img src="<?php echo plugins_url("assets/images/arrow_left.png", __DIR__); ?>" /></a>
						</td>
		...
		<table>
			<tr>
				...
				<td align="center">
					<a href="#" onClick="SelectAddRows(document.getElementById('learndash_group_users_view'), document.getElementById('learndash_group_users')); SelectAll(document.getElementById('learndash_group_users')); return false;"><img src="<?php echo plugins_url("assets/images/arrow_right.png", __DIR__); ?>" /></a><br>
					<a href="#" onClick="SelectRemoveRows(document.getElementById('learndash_group_users')); SelectAll(document.getElementById('learndash_group_users')); return false;"><img src="<?php echo plugins_url("assets/images/arrow_left.png", __DIR__); ?>" /></a>
				</td>
